create table campaigns (created_at timestamp(6) with time zone not null, id bigint generated by default as identity, status_id bigint not null, univers_id bigint, updated_at timestamp(6) with time zone not null, user_id bigint not null, description TEXT, title varchar(255) not null, primary key (id));
...
alter table if exists campaigns add constraint FKm0pcl7voj2fuj496jypoauuj7 foreign key (univers_id) references universes;
